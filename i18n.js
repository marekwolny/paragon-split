...
(function () {
  const EN = {
    ...
    'rozliczane osobno': 'settled separately',
    'nie obejmuje': 'excludes',
    'W złotówkach': 'In PLN',
    'W walucie': 'In',
    'Kliknij, aby przeliczać na złotówki': 'Tap to convert to PLN',
    'Kliknij, aby rozliczyć w tej walucie': 'Tap to settle in this currency',
    'Waluty w tym wyjeździe — odznacz tę, którą rozliczacie między sobą w niej samej, bez przeliczania na złotówki:': 'Currencies used on this trip — untick the one you settle between yourselves in that currency, without converting to PLN:',
    'rozliczony': 'settled',
    'wpłaty': 'paid',
